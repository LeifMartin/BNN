...
class vMF(nn.Module):
    ...
    def sample(self, N=1, rsf=10):
        ...
        e1mu[0, 0] = 1.0
        e1mu = e1mu - self.mu if len(self.mu.shape) == 2 else e1mu - self.mu.unsqueeze(1)
...
class BayesianLinear(nn.Module):
    def __init__(self, in_features, out_features, w_mu = None, b_mu=None):
        ...
        # Bias parameters
        self.bias_mu = nn.Parameter(b_mu, requires_grad=True)
        self.bias_rho = nn.Parameter(torch.Tensor(1).uniform_(1,10), requires_grad=True)
...
class BayesianNetwork(nn.Module):
    def __init__(self, w_mu1 = None, w_mu2 = None, w_mu3 = None, b_mu1=None, b_mu2=None, b_mu3=None, l1=(256, 400), l2=(400, 600), l3=(600, 5), l4=(5,5), VD='Gaussian', BN='notbatchnorm'):
        super().__init__()
        l1_in, l1_out = l1
        l2_in, l2_out = l2
        l3_in, l3_out = l3
